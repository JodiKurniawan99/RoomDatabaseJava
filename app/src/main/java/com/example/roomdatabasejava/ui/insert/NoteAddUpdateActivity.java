...
import com.example.roomdatabasejava.databinding.ActivityNoteAddUpdateBinding;
import com.example.roomdatabasejava.helper.DateHelper;
...
//                intent.putExtra(EXTRA_NOTE, note);
    ...
    private static NoteAddUpdateViewModel obtainViewModel(AppCompatActivity activity) {
        ...
        return new ViewModelProvider((ViewModelStoreOwner) activity, (ViewModelProvider.Factory) factory).get(NoteAddUpdateViewModel.class);
    }
